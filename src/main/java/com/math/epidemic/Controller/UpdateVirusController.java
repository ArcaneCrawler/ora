...
public class UpdateVirusController {
    ...
    public void onAdd(ActionEvent actionEvent) {
        ...
        alert.setTitle("Locacity add pane");
        alert.setHeaderText("Результат:");
        alert.setContentText("Вирусное заболевание успешно изменено");
        alert.showAndWait();
    }
    ...
    public void init()
    {
         nameField.setText(virus.getName());
        stainField.setText(virus.getStrain());
        lethalField.setText(String.valueOf(virus.getLethal()));
        influenceField.setText(String.valueOf(virus.getInfluence()));
        evol_rateField.setText(String.valueOf(virus.getEvol_rate()));
        enduranceField.setText(String.valueOf(virus.getEndurance()));
        cure_rateField.setText(String.valueOf(virus.getCure_rate()));
